...
1. **Scenario and story IDs — platform-provisioned only (BLOCKING).**
   ...
   - **After IDs exist**: Add SmartTest link comments using the **actual** platform ids (or ids already present in committed plan markdown). Full rules: [`references/author-plans.md`](references/author-plans.md).
