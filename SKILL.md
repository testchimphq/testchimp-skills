...
| `/testchimp implement` / `/testchimp implement <story/scenario id>` | [`references/implement-requirement.md`](references/implement-requirement.md) — workflow **`implement`**; Analyze → Plan → Execute → Report (`IMPLEMENTED` + [Report workflow execution](references/policies-and-traceability.md#report-workflow-execution)). |
