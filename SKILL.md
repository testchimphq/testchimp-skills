...
| `/testchimp author test for manual session` (or pasted **Copy script generate prompt**) | [`references/author-test-from-manual-session.md`](references/author-test-from-manual-session.md). |
...
| [`references/write-smarttests.md`](references/write-smarttests.md) | SmartTest authoring details used by the execution phase |
