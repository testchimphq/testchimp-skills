...
| [`references/run-qa.md`](references/run-qa.md) | `/testchimp run QA` / `test` (`run-qa`): Analyze → Plan → Execute → Validate → Phase 5 (Smart regression) → Phase 6 → Phase 7 |
